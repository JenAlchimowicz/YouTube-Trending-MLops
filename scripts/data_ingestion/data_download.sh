...
aws s3 cp ./data/raw_data/GB_youtube_trending_data.csv s3://yt-trending-mlops/data/raw_data/ --profile yt-trending
aws s3 cp ./data/raw_data/GB_category_id.json s3://yt-trending-mlops/data/raw_data/ --profile yt-trending
